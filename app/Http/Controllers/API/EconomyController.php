...
{
    public function getProducts($server, $resource, $country, $quality)
    {
        if ($country == 0) {
            $country = -1;
        }
    ...
    public function getExchange($server, $from, $to)
    {
    ...
    public function getJobs($server, $country, $skill)
    {
    ...
    public function getAuctions($server, $status, $sorting, $page)
    {
